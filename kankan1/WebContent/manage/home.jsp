	...
	<div class="page-content clearfix">
		...
		<div class="state-overview clearfix">
			...
			<div class="col-lg-3 col-sm-6">
				...
				<div class="value">
					<h1><%=session.getAttribute("customernums") %></h1>
					<p>分销记录</p>
				</div>
				</section>
			</div>
		...
		<div class="clearfix">
			...
			<div class="news_style">
				...
				<ul class="list">
					<li><i class="icon-bell red"></i><a href="javascript:void(0)">后台系统找那个是开通了。</a></li>
					<li><i class="icon-bell red"></i><a href="javascript:void(0)">6月共处理订单3451比，作废为...</a></li>
					<li><i class="icon-bell red"></i><a href="javascript:void(0)">后台系统找那个是开通了。</a></li>
					<li><i class="icon-bell red"></i><a href="javascript:void(0)">后台系统找那个是开通了。</a></li>
					<li><i class="icon-bell red"></i><a href="javascript:void(0)">后台系统找那个是开通了。</a></li>
				</ul>
