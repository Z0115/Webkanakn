								...
								<div class="side_list">
									...
									<div class="widget-body">
										<ul class="b_P_Sort_list">
											<li><i class="fa fa-users green"></i> <a
												href="javascript:void(0)">全部管理员（13）</a></li>
											<li><i class="fa fa-users orange"></i> <a
												href="javascript:void(0)">超级管理员（1）</a></li>
											<li><i class="fa fa-users orange"></i> <a
												href="javascript:void(0)">普通管理员（5）</a></li>
											<li><i class="fa fa-users orange"></i> <a
												href="javascript:void(0)">产品编辑管理员（4）</a></li>
											<li><i class="fa fa-users orange"></i> <a
												href="javascript:void(0)">管理员（1）</a></li>
										</ul>
									</div>
								</div>
							</div>
