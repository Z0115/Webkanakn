     ...
     <div class="side_list">
      ...
      <div class="widget-body">
         <ul class="b_P_Sort_list">
             <li><i class="orange  fa fa-user-secret"></i><a href="javascript:void(0)">全部(77)</a></li>
             <li><i class="fa fa-diamond pink "></i> <a href="javascript:void(0)">普通会员(24)</a></li>
             <li> <i class="fa fa-diamond pink "></i> <a href="javascript:void(0)">铜牌会员(22)</a></li>
             <li><i class="fa fa-diamond pink "></i> <a href="javascript:void(0)">银牌会员(18)</a></li>
             <li><i class="fa fa-diamond pink "></i> <a href="javascript:void(0)">金牌会员(13)</a></li>
  </div>
  </div>
  </div>  
  </div>
