...
<body>
	<div class="page-content clearfix">
			...
			<div class="brand_info clearfix">
				...
				<form>
					<ul class="Info_style clearfix">
						...
						<li><label class="label_name">添加时间：</label><span class="name">2016-6-21
								34：23</span></li>
						<li><label class="label_name">状&nbsp;&nbsp;&nbsp;&nbsp;态：</label><span
							class="name">启用</span></li>
						<li class="b_Introduce"><label class="label_name">品牌介绍：</label><span
							class="name">玉兰油OLAY，是宝洁公司全球著名的护肤品牌，是中国区最大护肤品牌，在大陆已持续十年呈两位数增长。OLAY以全球高科技护肤研发技术为后盾，在深入了解中国女性对护肤和美的需要的基础上，不断扩大产品范围，目前已经涵盖了护肤和沐浴系列，真正帮助女性全面周到地呵护自己的肌肤。玉兰油全球销售额近十亿美金，成为世界上最大、最著名的护肤品牌之一。卓越的护肤功效获得世界爱美女性肯定，迅速畅销150多个国家。</span></li>
					</ul>
		...
		<div class="border clearfix">
			<span class="l_f"> <a href="product-add.html" title="添加商品"
			...
			</span> <span class="r_f">该品牌下共：<b>234</b>件商品
			</span>
		</div>
		<!--产品列表-->
				...
				<div class="widget-box side_content">
					...
					<div class="side_list">
						<div class="widget-header header-color-green2">
							<h4 class="lighter smaller">产品所属分类</h4>
						</div>
						<div class="widget-body">
							<ul class="b_P_Sort_list">
								<li><i class="orange icon-folder-close"></i></i><a
									href="javascript:void(0)">全部(235)</a></li>
								<li><i class="icon-file-text grey"></i> <a
									href="javascript:void(0)">乳液面霜(5)</a></li>
								<li><i class="icon-file-text grey"></i><a
									href="javascript:void(0)">套装(15)</a></li>
								<li><i class="icon-file-text grey"></i><a
									href="javascript:void(0)">洁面(6)</a></li>
								<li><i class="icon-file-text grey"></i> <a
									href="javascript:void(0)">精华(2)</a></li>
								<li><i class="icon-file-text grey"></i> <a
									href="javascript:void(0)">爽肤水(12)</a></li>
								<li><i class="icon-file-text grey"></i><a
									href="javascript:void(0)">防晒(6)</a></li>
								<li><i class="icon-file-text grey"></i><a
									href="javascript:void(0)">面膜(7)</a></li>
								<li><i class="icon-file-text grey"></i><a
									href="javascript:void(0)">眼霜(23)</a></li>
								<li><i class="icon-file-text grey"></i><a
									href="javascript:void(0)">精华露(53)</a></li>
								<li><i class="icon-file-text grey"></i><a
									href="javascript:void(0)">爽肤水(25)</a></li>
								<li><i class="icon-file-text grey"></i><a
									href="javascript:void(0)">隔离(52)</a></li>
								<li><i class="icon-file-text grey"></i> <a
									href="javascript:void(0)">眼部护理(45)</a></li>
							</ul>
					...
					<tbody>
						<tr>
							...
							<td width="250px"><u style="cursor: pointer"
								class="text-primary" onclick="">Olay玉兰油 新生塑颜金纯面霜50g（大红瓶） </u></td>
						...
						<tr>
							...
							<td width="80px">45631</td>
							<td width="250px"><u style="cursor: pointer"
								class="text-primary" onclick="">玉兰油 Olay 新生塑颜金纯面霜轻盈无香精型50g
									(大红瓶抗皱紧致 补水保湿) </u></td>
							<td width="100px">5467</td>
							<td width="100px">4525</td>
							<td width="100px">法国</td>
						...
						<tr>
							...
							<td width="80px">45631</td>
							<td width="250px"><u style="cursor: pointer"
								class="text-primary" onclick="">玉兰油 Olay 多效修护霜50g(乳液面霜 补水保湿
									提拉紧致) </u></td>
							<td width="100px">5467</td>
							<td width="100px">4525</td>
							<td width="100px">法国</td>
						...
						<tr>
							...
							<td width="250px"><u style="cursor: pointer"
								class="text-primary" onclick="">Olay玉兰油 多效修护粉嫩气色霜50g（保养级BB霜
									裸妆） 4G手机Y</u></td>
							<td width="100px">5467</td>
							<td width="100px">4525</td>
							<td width="100px">法国</td>
						...
						<tr>
							...
							<td width="250px"><u style="cursor: pointer"
								class="text-primary" onclick="">Olay玉兰油
									多效修护润舒霜50g（补水保湿、细腻肌肤） </u></td>
							<td width="100px">5467</td>
							<td width="100px">4525</td>
							<td width="100px">法国</td>
							<td width="180px">2014-6-11 11:11:42</td>
						...
						<tr>
							...
							<td width="250px"><u style="cursor: pointer"
								class="text-primary" onclick="">Olay玉兰油 水感透皙莹肌亮肤液 150ml
									4G手机Y</u></td>
							<td width="100px">5467</td>
							<td width="100px">4525</td>
							<td width="100px">法国</td>
						...
						<tr>
							...
							<td width="250px"><u style="cursor: pointer"
								class="text-primary" onclick="">Olay玉兰油 水感透白亮肤凝乳75ml（提亮肤色） </u></td>
							<td width="100px">5467</td>
							<td width="100px">4525</td>
							<td width="100px">法国</td>
							<td width="180px">2014-6-11 11:11:42</td>
						...
						<tr>
							...
							<td width="250px"><u style="cursor: pointer"
								class="text-primary" onclick="">Olay玉兰油 活肤菁华霜50g（补水 保湿 ） </u></td>
							<td width="100px">5467</td>
							<td width="100px">4525</td>
							<td width="100px">法国</td>
							<td width="180px">2014-6-11 11:11:42</td>
						...
						<tr>
							...
							<td width="250px"><u style="cursor: pointer"
								class="text-primary" onclick="">Olay玉兰油 白里透红嫩白乳液75ml（保湿 滋润)
									4G手机Y</u></td>
							<td width="100px">5467</td>
							<td width="100px">4525</td>
							<td width="100px">法国</td>
