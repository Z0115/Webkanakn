...
<body>
				...
				<table class="table table-striped table-bordered table-hover"
					...
					<tbody>
						<tr>
							...
							<td>4577566</td>
							<td>华陈子</td>
							<td><a href="javascript:ovid()"
								onclick="integration_history('23')">3455</a></td>
							<td><a href="javascript:ovid()"
								onclick="Browse_history('13')">223</a></td>
							<td><a href="javascript:ovid()"
								onclick="Order_history('33')">452</a></td>
						...
						<tr>
							...
							<td>李打扎</td>
							<td><a href="javascript:ovid()"
								onclick="integration_history('43')">6323</a></td>
							<td><a href="javascript:ovid()"
								onclick="Browse_history('53')">356</a></td>
							<td><a href="javascript:ovid()"
								onclick="Order_history('23')">556</a></td>
							<td><a title="删除" href="javascript:;"
								onclick="member_del(this,'2')" class="btn btn-xs btn-warning"><i
									class="fa fa-trash  bigger-120"></i></a></td>
						</tr>
						<tr>
							<td><label><input type="checkbox" class="ace"><span
							...
							<td>梅毒</td>
							<td><a href="javascript:ovid()"
								onclick="integration_history('5')">3423</a></td>
							<td><a href="javascript:ovid()"
								onclick="Browse_history('4')">123</a></td>
							<td><a href="javascript:ovid()" onclick="Order_history('5')">234</a></td>
							<td><a title="删除" href="javascript:;"
								onclick="member_del(this,'3')" class="btn btn-xs btn-warning"><i
									class="fa fa-trash  bigger-120"></i></a></td>
						</tr>
						<tr>
							<td><label><input type="checkbox" class="ace"><span
							...
							<td>张小泉</td>
							<td><a href="javascript:ovid()"
								onclick="integration_history('5')">245</a></td>
							<td><a href="javascript:ovid()"
								onclick="Browse_history('4')">131</a></td>
							<td><a href="javascript:ovid()" onclick="Order_history('7')">45</a></td>
							<td><a title="删除" href="javascript:;"
								onclick="member_del(this,'5')" class="btn btn-xs btn-warning"><i
									class="fa fa-trash  bigger-120"></i></a></td>
						</tr>
					</tbody>
				</table>
	...
	<div id="integration_history" style="display: none; padding: 10px;">
		<table class="table table-striped table-bordered table-hover"
			id="integration_history_list" width="100%">
			<thead>
				<tr>
					<th width="80">用户</th>
			...
			<tbody>
				<tr>
					<td>花海天天</td>
					<td><a href="javascript:void(0)">荣耀7i 海岛蓝 移动4G手机 双卡双待 </a></td>
					<td>2565</td>
					<td>1234</td>
				...
				<tr>
					<td>花海天天</td>
					<td><a href="javascript:void(0)">华为 畅享5S 金色 移动联通电信4G手机 </a></td>
					<td>2565</td>
					<td>1234</td>
					<td>2016-7-12 12:23:34</td>
				</tr>
				...
				<tr>
					<td>花海天天</td>
					<td><a href="javascript:void(0)">乐视（Le）乐2Pro 32GB 金色 移动联通</a></td>
					<td>4566</td>
					<td>3455</td>
					<td>2016-7-12 12:23:34</td>
				</tr>
				<tr>
					<td>花海天天</td>
					<td><a href="javascript:void(0)">华为 P9 plus 64GB 琥珀金
							移动联通电信卡双待 </a></td>
					<td>231</td>
					<td>11</td>
					<td>2016-7-12 12:23:34</td>
	...
	<div id="Browse_history" style="display: none; padding: 10px">
		<table class="table table-striped table-bordered table-hover"
			id="Browse_history_list" width="100%">
			<thead>
				<tr>
					<th width="80">用户</th>
					<th width="100">产品名称</th>
	...
	<div id="Order_history" style="display: none; padding: 10px;">
		...
		<table class="table table-striped table-bordered table-hover"
			id="Order_history_list" width="100%">
			<thead>
				<tr>
					<th width="80">用户</th>
					<th width="100">订单号</th>
			...
			<tbody>
				<tr>
					<td>花海天天</td>
					<td><a href="javascript:void(0)">hd23342354534534 </a></td>
					<td>2</td>
					<td>已完成</td>
					<td>2016-7-12 12:23:34</td>
				</tr>
				...
				<tr>
					<td>花海天天</td>
					<td><a href="javascript:void(0)">hd2335464544534534</a></td>
					<td>3</td>
					<td>交易失败</td>
					<td>2016-7-12 12:23:34</td>
				</tr>
